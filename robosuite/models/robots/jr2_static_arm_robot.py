...
class JR2StaticArm(Robot):
    """JR2."""

    def __init__(self):
        super().__init__(xml_path_completion("robots/jr2/jr2_static_arm.xml"))
    ...
    def init_arm_qpos(self):
        ...
        pos = np.array([-0.9864941,1.68345062,0.8218911,-5.26739192,-0.01367158,-0.1648811])
